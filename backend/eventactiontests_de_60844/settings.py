"""
Django settings for eventactiontests_de_60844 project.
...
ROOT_URLCONF = 'eventactiontests_de_60844.urls'
...
WSGI_APPLICATION = 'eventactiontests_de_60844.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "eventactiontests_de_60844 API",
    "DESCRIPTION": "API documentation for eventactiontests_de_60844 App",
    "VERSION": "v1",
}
