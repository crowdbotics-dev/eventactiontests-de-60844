...
## Project Structure
    ...
    ├── eventactiontests_de_60844  # Django project configurations
...
1. Clone this repo and `cd eventactiontests_de_60844`
...
2. Clone this repo and `cd eventactiontests_de_60844`
